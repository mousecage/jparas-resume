...
%TODO: This needs to be external to these files. 
\personalinfo{%
...
%TODO: This needs to be external to these files. \smallskip
\textbf{Tasks:}
\begin{itemize}
...
\wheelchart{1.5cm}{0.5cm}{%
  ...
  20/10em/accent/Problem Solving,
...
\begin{quote}
``Dedicated and talented Site Reliability Engineer with a strong background in computer science looking for a position that will allow me to grow''
\end{quote}
